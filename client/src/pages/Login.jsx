    ...
    >
      <div className="max-w-md w-full bg-surface rounded-2xl shadow-high border border-border-muted overflow-hidden">
        <div className="p-8">
          ...
          <h2 className="text-2xl font-bold text-center text-text-primary mb-2 font-display">Welcome Back</h2>
          <p className="text-center text-text-secondary text-sm mb-8">Sign in to continue to your meal planner.</p>
          ...
          <p className="mt-8 text-center text-sm text-text-secondary">
            ...
            <Link to="/register" className="font-semibold text-primary hover:text-amber-800 transition-colors">
              Create an account
            </Link>
          </p>
        </div>
